...
/** v11 added the collection PATCH that names chapter one. A client one version
 * ahead would otherwise pass preflight against an older server and then take a
 * 404 in the middle of a rename. */
