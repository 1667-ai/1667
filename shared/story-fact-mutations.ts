...
import { FactBudgetError, parseFactBudgetTokens } from "./fact-budget.js";
import {
  canonicalFactStates,
...
import { hasDefinedProperty, requireRecord } from "../server/validation.js";
import {
  MAX_FACTS,
  MAX_FACT_STATES,
  MAX_FACT_TEXT_CHARS,
...
import { factTagWithinLimit, factTextWithinLimit } from "./fact-limits.js";
 ...
 * when the mutation is replayed by the worker. */
