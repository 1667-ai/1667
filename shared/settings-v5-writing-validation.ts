import { canonicalJson } from "./canonical-json-core.js";
import {
  SettingsFormatError,
...
import { MAX_WRITING_OBJECT_BYTES } from "./settings-v5-limits.js";
import {
...
export function assertWritingObjectBudget(
  ...
  const bytes = new TextEncoder().encode(canonicalJson(writing)).byteLength;
