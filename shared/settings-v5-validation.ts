...
import {
  parseConnections
} from "./settings-v2-connection-validation.js";
import { parseModelsV3 } from "./settings-v3-model-validation.js";
...
import { closedRecord, closedShape, literal } from "./settings-wire-validation.js";
...
export function validateSettingsDocumentV5(
  ...
  const caseInsensitive = options.environmentCaseInsensitive ?? false;
